...
// Store hashed code in database (using password_change_token fields)
$stmt = $conn->prepare("UPDATE users SET password_change_token = ?, password_change_token_expires = DATE_ADD(NOW(), INTERVAL 10 MINUTE) WHERE id = ?");
